namespace Discord
{
    public interface IVoiceState
    {
        ...
        /// <summary>
        /// Returns true if the guild is temporarily blocking audio from this user.
        /// </summary>
        /// <remarks>
        /// Examples of when this value would be true include when the voice channel requires the use
        /// of push-to-talk, but the user does not have push-to-talk configured.
        /// </remarks>
